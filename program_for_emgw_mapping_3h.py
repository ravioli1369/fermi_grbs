...
def get_obs_times(file, time, observatory=astroplan.Observer.at_site("iao"),
    ...
    if len(rise_time) == 0:
        ...
        if start_time + 3*u.hour < end_time:
            end_time = start_time + 3*u.hour
...
if __name__ == '__main__':
    ...
    output_name = file + "_scheduled_3h.csv"
    time = args.time
    if time is not None:
    ...
    if obs_times[0] == 0:
        ...
        with open("/home/ravioli/astro/git/fermi_grbs/coverage_3h.csv", "a") as f:
